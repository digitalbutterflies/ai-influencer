...
// cross-instance limiting you'd add a shared store (for example Cloudflare KV) -
...
// Pull the visitor's IP from Cloudflare or fallback proxy headers. Works with both an edge
